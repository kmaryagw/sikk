                                ...
                                <form action="{{ route('prodi.update', $prodi->prodi_id) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="id_falkutas" id="id_falkutas">
                                            ...
                                            @foreach ($falkutas as $falkutasItem)
                                                <option value="{{ $falkutasItem->id_falkutas }}" 
                                                    {{ old('id_falkutas', $prodi->id_falkutas) == $falkutasItem->id_falkutas ? 'selected' : '' }}>
                                                    {{ $falkutasItem->nama_falkutas }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
