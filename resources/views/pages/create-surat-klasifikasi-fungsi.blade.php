...
@section('title', 'create-surat-klasifikasi-fungsi')
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Form Surat Klasifikasi Fungsi</h1>
            </div>
                    ...
                    <div class="col-12 col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('suratfungsi.store') }}">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        <label for="skf_aktif">Aktif</label>
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">
                                            ...
                                            <select class="form-control" id="skf_aktif" name="skf_aktif">
                                                @foreach ($skfaktifs as $aktif)
                                                    <option value="{{ $aktif }}" {{ old('skf_aktif', 'y') == $aktif ? 'selected' : '' }}>
                                                        {{ $aktif == 'y' ? 'Ya' : 'Tidak' }}
                                                    </option>
                                                @endforeach
                                            </select>
