...
@section('title', 'create-surat-klasifikasi-perihal')
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Form Surat Klasifikasi Perihal</h1>
            </div>
                    ...
                    <div class="col-12 col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('suratperihal.store') }}">
                                    @csrf
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" type="text" name="skp_nama" id="skp_nama" value="{{ old('skp_nama') }}"/>
                                        </div>
                                    </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-control" id="skp_aktif" name="skp_aktif">
                                                @foreach ($skpaktifs as $aktif)
                                                    <option value="{{ $aktif }}" {{ old('skp_aktif', 'y') == $aktif ? 'selected' : '' }}>
                                                        {{ $aktif == 'y' ? 'Ya' : 'Tidak' }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-control" name="skf_id" id="skf_id">
                                                ...
                                                @foreach ($suratfungsi as $fungsi)
                                                    <option value="{{ $fungsi->skf_id }}" {{ old('skf_id') == $fungsi->skf_id ? 'selected' : '' }}>
                                                        {{ $fungsi->skf_nama }}
                                                    </option>
                                                @endforeach
                                            </select>
