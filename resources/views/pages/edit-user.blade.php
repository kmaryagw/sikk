                                    ...
                                    <div class="mb-3" id="fakultas_field" style="display: none;">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-control" name="id_fakultas">
                                                <option value="" {{ is_null($user->id_fakultas) ? 'selected' : '' }}>Pilih Fakultas (Opsional)</option>
                                                @foreach ($fakultasns as $fakultas)
                                                    <option value="{{ $fakultas->id_fakultas }}" {{ old('id_fakultas', $user->id_fakultas) == $fakultas->id_fakultas ? 'selected' : '' }}>{{ $fakultas->nama_fakultas }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-control" name="prodi_id">
                                                ...
                                                @foreach ($prodis as $prodi)
                                                    <option value="{{ $prodi->prodi_id }}" {{ old('prodi_id', $user->prodi_id) == $prodi->prodi_id ? 'selected' : '' }}>{{ $prodi->nama_prodi }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-control" name="unit_id">
                                                ...
                                                @foreach ($units as $unit)
                                                    <option value="{{ $unit->unit_id }}" {{ old('unit_id', $user->unit_id) == $unit->unit_id ? 'selected' : '' }}>{{ $unit->unit_nama }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
